...
func (s *SMB3_7_0_S0_biosinformationindicator) GetBIOSVersion(strings []string) string {
...
func (s *SMB3_7_0_S0_biosinformationindicator) GetBIOSReleaseDate(strings []string) string {
...
func (s *SMB3_7_0_S0_biosinformationindicator) GetBIOSROMSize() byte {
	return s.BIOSROMSize
}

func (s *SMB3_7_0_S0_biosinformationindicator) GetBIOSCharacteristics() uint64 {
	return s.BIOSCharacteristics
}

func (s *SMB3_7_0_S0_biosinformationindicator) GetBIOSCharacteristicsExtensionBytes() [2]byte {
	return s.BIOSCharacteristicsExtensionBytes
}

func (s *SMB3_7_0_S0_biosinformationindicator) GetSystemBIOSMajorRelease() byte {
	return s.SystemBIOSMajorRelease
}

func (s *SMB3_7_0_S0_biosinformationindicator) GetSystemBIOSMinorRelease() byte {
