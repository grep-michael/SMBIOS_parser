...
type S_MemoryControllerInformationType5Obsolete struct {
	...
	MemoryModuleConfigurationHandles interface{} // Type:x WORDs
...
type S_BIOSLanguageInformationType13 struct {
	...
	Reserved interface{} // Type:15 BYTES
...
type S_SystemEventLogType15 struct {
	...
	ListofSupportedEventLogTypeDescriptors interface{} // Type:Varies
}
...
type S_SystemBootInformationType32 struct {
	...
	Length byte //
	Handle uint16 //
	Reserved interface{} // Type:6 BYTEs
	BootStatus interface{} // Type:Length-10 Bytes
}
type S_64 struct {
	Type byte //
	Length byte //
...
type S_AdditionalInformationType40 struct {
	...
	AdditionalInformationentries interface{} // Type:Varies
}
...
type S_ManagementControllerHostInterfaceType42 struct {
	...
	Handle uint16 //
	InterfaceType byte //ENUM
	MCHostInterfaceData interface{} // Type:n BYTEs
}
